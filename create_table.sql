...
BEGIN
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'Alergia comeÃ§ou ontem e piorou durante a noite', id_paciente);
-------------------------------------2   
    ...
    -- Obtendo o valor atual da sequÃªncia seq_autentica
    SELECT seq_autentica.currval INTO id_autentica FROM DUAL;
    
    -- InserÃ§Ãµes nas tabelas T_TD_PACIENTE
    INSERT INTO T_TD_PACIENTE (id_paciente, nm_paciente, nr_cpf, nr_rg, dt_nascimento, fl_sexo, tip_grupo_sanguineo, id_autentica) VALUES (seq_paciente.nextval, 'AngÃ©lica', '33333333332', '122321214', '19/08/2004', 'm', 'A -', id_autentica);
    
    -- Obtendo o valor atual da sequÃªncia seq_paciente
    SELECT seq_paciente.currval INTO id_paciente FROM DUAL;
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'IrritaÃ§Ã£o na pele persistente, acompanhada de coceira intensa', id_paciente);
-------------------4
    ...
    INSERT INTO T_TD_ENDERECO_PACIENTE (id_endereco, CEP, nr_logradouro, ds_ponto_referencia, id_paciente)VALUES (seq_endereco_paciente.nextval, '02145012', 789, 'perto da farmÃ¡cia', id_paciente);
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'VermelhidÃ£o e descamaÃ§Ã£o da pele devido a exposiÃ§Ã£o a alÃ©rgenos', id_paciente);
-------------------5
    INSERT INTO T_TD_AUTENTICA  (id_autentica, login ,  senha ,  st_login  ) VALUES (seq_autentica.nextval, 'login5','senha5', 'a');

    SELECT seq_autentica.currval INTO id_autentica FROM DUAL;

    INSERT INTO T_TD_PACIENTE (id_paciente,nm_paciente,nr_cpf ,nr_rg ,dt_nascimento,fl_sexo ,tip_grupo_sanguineo,id_autentica) VALUES (seq_paciente.nextval, 'JoÃ£o Silva', '12345678901', ' 123456789', '15/05/1990 ', 'm', 'A+', id_autentica );
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'Agravamento dos sintomas durante perÃ­odos de estresse emocional', id_paciente);
-------------------6
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'Piora da Dermatite AtÃ³pica devido Ã  exposiÃ§Ã£o a mudanÃ§as climÃ¡ticas', id_paciente);
-------------------7
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'IrritaÃ§Ã£o e vermelhidÃ£o na pele devido ao uso de roupas apertadas e sintÃ©ticas', id_paciente);
-------------------8
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'Coceira comeÃ§ou apos contato com perfumes especÃ­ficos ', id_paciente);
-------------------9
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'Coceira comeÃ§ou em Ã©poca de polinizaÃ§Ã£o elevada ', id_paciente);
-------------------10
    ...
    INSERT INTO T_TD_QUADRO_CLINICO (id_quadro_clinico,ds_alergias,id_paciente) VALUES (seq_quadro_clinico.nextval,'Alergia comeÃ§ou semana passada e houve uma piora na coceira e ocorreu descamaÃ§Ã£o', id_paciente);

END;



INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital Santa Clara', 940, 23456789, '17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital Bom Jesus', 89, 45678901, '17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital São Francisco', 2300, 56789012, '17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital Santo Antônio', 753, 67890123, '17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval, 'Hospital Nossa Esperança', 230, 78901234,'17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital Vida Plena', 1060, 89012345, '17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital Luz Divina', 100, 90123456, '17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital Esperança', 1400, 23456780, '17/11/2023');
 
INSERT INTO t_td_unid_hospitalar (id_unid_hospitalar,razao_social ,nr_logradouro, CEP, dt_cadastro ) values
 (seq_unid_hospitalar.nextval,'Hospital Cura Total', 320, 12345670, '17/11/2023') ;
...
WHERE
  ...
  --------SELECT COM FUNÇÃO
  ------- MOSTRAR QUANTIDADE DE PACIENTE POR SEXO
SELECT
    T_TD_PACIENTE.fl_sexo,
...
GROUP BY
   ...
   --------SELECT COM HAVING  
   ------ NÚMERO TOTAL DE PACIENTES PARA CADA GRUPO SANGUÍNEO, 
SELECT
T_TD_PACIENTE.tip_grupo_sanguineo,
COUNT(T_TD_PACIENTE.id_paciente) AS total_pacientes,
    T_TD_AUTENTICA.login
...
INNER JOIN
    T_TD_AUTENTICA ON T_TD_PACIENTE.id_autentica = T_TD_AUTENTICA.id_autentica
GROUP BY
    T_TD_PACIENTE.tip_grupo_sanguineo, T_TD_AUTENTICA.login
HAVING
    COUNT(T_TD_PACIENTE.id_paciente) < 10;
...
delete from t_td_unid_hospitalar;
